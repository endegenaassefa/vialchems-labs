 ...
 * vialchemlabs wordmark + RUO). 7 SKUs + Recovery Stack bundle.
 *
...
export const alt = 'vialchemlabs research peptide';
...
export default async function Image({
  ...
  const compound = product?.shortName ?? bundle?.name ?? 'vialchemlabs';
          ...
          >
            <div
              style={{
                ...
                height: '32px',
                background:
                  'linear-gradient(180deg, #5a6065 0%, #3a4045 100%)',
            ...
            >
              ...
              >
                ...
                {dose ? (
                  <div style={{ color: '#5eebdf' }}>{dose}</div>
                ) : null}
                <div
                  style={{
                    fontSize: '8px',
