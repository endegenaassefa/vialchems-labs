...
| axe per page: 0 violations                                                                                                          | **DEFERRED** to Phase 8 a11y lift; Phase 6 _adds_ a11y improvements via Toast (role=alert) replacing inline status divs on /contact + /affiliate |
