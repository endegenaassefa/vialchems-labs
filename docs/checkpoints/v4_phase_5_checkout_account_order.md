...
| axe per page: 0 violations | **DEFERRED** to Phase 8; Phase 5 *adds* a11y improvements via Dialog (focus management, role=dialog, aria-modal, Esc) and Toast (role=alert, aria-live) replacing the inline status paragraph |
