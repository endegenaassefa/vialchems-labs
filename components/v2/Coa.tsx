            ...
            >
              <div>
                ...
                <p style={{ color: "var(--fg-muted)", maxWidth: 640 }}>
                  Sample certificate records show the expected lot-tracking
                  format. Live certificates must be uploaded before shipment.
                </p>
                ...
                >
                  ...
                  <div style={{ textAlign: "right" }}>
                    <span className="badge badge-verified">
                      {record.status === "verified" ? "Verified" : "Sample"}
                    </span>
                  </div>
                </Link>
              ))}
