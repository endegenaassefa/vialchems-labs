...
export function V2Header() {
  ...
  const count = useCartStore((s) => s.lines.reduce((sum, line) => sum + line.qty, 0));
    ...
    <nav className="nav">
      <div className="container nav-inner">
        ...
        <div className="nav-actions">
          <ThemeSwitch />
          <Link className="icon-btn v2-nav-search" href="/shop" aria-label="Search catalog" title="Search catalog">
            <Icon.search size={14} strokeWidth={1.5} />
          </Link>
          <Link className="icon-btn v2-nav-account" href="/account" aria-label="Account" title="Account">
            <Icon.user size={14} strokeWidth={1.5} />
          </Link>
          <Link className="icon-btn v2-nav-cart" href="/cart" aria-label="Cart" title="Cart" style={{ position: 'relative' }}>
      ...
      <div className="container">
        <div className="foot-grid">
          <div className="foot-col">
            ...
            <p style={{ color: 'var(--fg-muted)', fontSize: 13, maxWidth: 320, marginBottom: 16 }}>
              Research-grade peptides sold only to verified laboratories and qualified research organizations.
            </p>
...
function ThemeSwitch() {
  ...
  return (
    ...
    >
      {theme === 'dark' ? <Icon.moon size={14} strokeWidth={1.5} /> : <Icon.sun size={14} strokeWidth={1.5} />}
