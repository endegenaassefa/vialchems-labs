...
const steps = [
  ...
  [
    "02",
    "Compliance review",
    "Buyer details, shipping eligibility, and research-use acknowledgement are reviewed.",
  ],
  [
    "03",
    "Unlock catalog access",
    "Restricted materials and order flow become available to qualified accounts.",
  ],
  [
    "04",
    "Verify each vial",
    "Match the lot code on the vial to the public COA record before bench intake.",
  ],
];
      ...
      <main id="main">
        ...
        >
          ...
          >
            ...
            <div
              className="card"
              style={{ padding: 20, boxShadow: "var(--shadow-lg)" }}
            >
              ...
              <table className="spec-table">
                <tbody>
                  ...
                  <tr>
                    <td>Shipping</td>
                    <td>Eligible US jurisdictions</td>
                  </tr>
                  <tr>
                    <td>Lot check</td>
                    <td>COA before bench use</td>
                  </tr>
                </tbody>
              </table>
            </div>
