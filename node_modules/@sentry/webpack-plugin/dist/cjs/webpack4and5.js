				...
				compiler.options.plugins.push(new BannerPlugin({
					...
					banner: (arg) => {
						...
						if (sourcemapsEnabled) {
							...
							const debugId = hash ? (0, _sentry_bundler_plugin_core.stringToUUID)(hash) : (0, node_crypto.randomUUID)();
...
Object.defineProperty(exports, "sentryWebpackPluginFactory", {
	enumerable: true,
	get: function() {
		return sentryWebpackPluginFactory;
	}
});
